...
/**
 * Custom RecyclerView that properly measures its content when inside a NestedScrollView by
 * calculating the total height of all items
 */
public class WrapContentRecyclerView extends RecyclerView {
    ...
    public WrapContentRecyclerView(
    ...
    protected void onMeasure(int widthSpec, int heightSpec) {
        android.util.Log.d(
                "WrapContentRV",
                "onMeasure called - heightSpec mode: "
                        + MeasureSpec.getMode(heightSpec)
                        + ", size: "
                        + MeasureSpec.getSize(heightSpec)
                        + ", adapter: "
                        + (getAdapter() != null ? getAdapter().getItemCount() + " items" : "null"));
                ...
                if (layoutManager != null) {
                    ...
                    for (int i = 0; i < itemCount; i++) {
                        ...
                        if (child == null) {
                            ...
                            child =
                                    getAdapter()
                                            .createViewHolder(this, getAdapter().getItemViewType(i))
                                            .itemView;
                        }
